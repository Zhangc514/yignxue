        ...
        <div class="col-md-2">
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" align="center">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><button class="btn btn-info" >用户统计</button><br><br></li>
                                <li><button class="btn btn-info" >用户分布</button><br><br></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-warning">
                    <div class="panel-heading" role="tab" id="FourheadingThree">
                        <h4 class="panel-title">
