...
public class LogAspect {
    ...
    @Around("@annotation(com.baizhi.zsj.annotation.AddLog)")
    ...
    //@Around("execution(* com.baizhi.zsj.serviceImpl.*.*(..) ) && !execution(* com.baizhi.zsj.serviceImpl.*.query*(..))")
