...
public class AliyunSendPhoneUtil {
    ...
    private static SendSmsResponse sendPhoneCode(String phoneNumbers,String signName,String templateCode,String templateParam) throws ClientException {
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI4Fp4xbKGiigG2CWzBjt6";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "ZfBr6EbokdfrwnTre4rsKOYRsOftpQ";//你的accessKeySecret，参考本文档步骤2
    ...
    public static String sendCode(String phones,String code){
        ...
        String templateCode="SMS_186968713";  //模板
    ...
    public static void main(String[] args) {
        String phones="15511379718,13131916023";
