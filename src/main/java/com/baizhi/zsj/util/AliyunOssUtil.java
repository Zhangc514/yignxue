...
public class AliyunOssUtil {
    ...
    private static String accessKeyId = "LTAI4Fp4xbKGiigG2CWzBjt6";
    private static String accessKeySecret = "ZfBr6EbokdfrwnTre4rsKOYRsOftpQ";

    private static String bucket="yingxue-app";
